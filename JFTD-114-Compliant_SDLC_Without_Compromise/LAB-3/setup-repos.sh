...
create-remote-repos(){
    ...
    reposData="[ { \"key\": \"jftd114-mvn-remote\", \"packageType\": \"maven\", \"rclass\": \"remote\", \"url\": \"https://repo1.maven.org/maven2/\", \"xrayIndex\": true} ]"
...
create-local-repos(){
    ...
    reposData="[ {\"key\": \"jftd114-mvn-snapshot-local\", \"packageType\": \"maven\", \"rclass\": \"local\", \"xrayIndex\": true }, { \"key\": \"jftd114-mvn-dev-local\", \"packageType\": \"maven\", \"rclass\": \"local\", \"environments\": [ \"DEV\" ], \"xrayIndex\": true }, { \"key\": \"jftd114-mvn-prod-local\", \"packageType\": \"maven\", \"rclass\": \"local\", \"environments\": [ \"PROD\" ], \"xrayIndex\": true }  ]"
...
create-virtual-repos(){
    ...
    reposData="[ { \"key\": \"jftd114-mvn-virtual\", \"packageType\": \"maven\", \"rclass\": \"virtual\", \"description\": \"The virtual repository public description\", \"defaultDeploymentRepo\": \"jftd114-mvn-snapshot-local\", \"repositories\": [ \"jftd114-mvn-snapshot-local\", \"jftd114-mvn-dev-local\", \"jftd114-mvn-prod-local\", \"jftd114-mvn-remote\"], \"xrayIndex\": true }  ]"
